...
export function ReportsPage() {
  ...
  // Determine which squad is leading (can be 'squad-a' or 'squad-b')
  const leadingSquad = 'squad-b'; // Change this to 'squad-a' if Squad A is leading
            ...
            <Card className="relative overflow-hidden group w-full h-full">
              ...
              <CardContent className="relative z-10">
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-card-inner rounded-lg p-4 border border-card-border">
                    <div className="text-xs text-muted mb-1">{translations.reports.netProfit}</div>
                    <div className="text-2xl font-heading font-bold text-glow-blue">
                      $237,452.08
                    </div>
                  </div>
                  <div className="bg-card-inner rounded-lg p-4 border border-card-border">
